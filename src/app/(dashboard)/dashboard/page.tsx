...
import { Plus, Activity, CheckCircle2, AlertCircle, Cpu, Clock, CheckCircle } from "lucide-react";
import { motion } from "framer-motion";

export default function DashboardPage() {
  const stats = [
    { label: "ACTIVE", value: "24", icon: Activity, color: "bg-blue-100 text-blue-600", borderColor: "border-transparent" },
    { label: "COMPLETED", value: "1,482", icon: CheckCircle2, color: "bg-orange-100 text-orange-600", borderColor: "border-transparent" },
    { label: "FAILED", value: "3", icon: AlertCircle, color: "bg-red-100 text-red-600", borderColor: "border-transparent" },
    { label: "SYSTEM LOAD", value: "68%", icon: Cpu, color: "bg-indigo-100 text-indigo-600", borderColor: "border-indigo-600", trend: "12%" },
  ];

  const requests = [
    { id: "#REQ-8291", status: "PROCESSING", title: "Neural Sync Calibration", desc: "Initiating synchronization of distributed node clusters across th...", type: "progress", value: 72 },
    { id: "#REQ-8292", status: "QUEUED", title: "Log Archeological Cleanup", desc: "Scheduled maintenance for archivi... system logs from Q3-2023 to cold", type: "wait", value: "~4m 20s", pct: 10 },
    { id: "#REQ-8290", status: "COMPLETED", title: "Auth-Gate Redundancy", desc: "Implementation of secondary authentication gates for the core...", type: "runtime", value: "12m 45s", pct: 100 },
    { id: "#REQ-8289", status: "FAILED", title: "Quantum Mesh Patch", desc: "Critical failure during the deployme... of the quantum mesh encryption", type: "error", value: "ERR_QM_404", pct: 30 },
    { id: "#REQ-8288", status: "PROCESSING", title: "Data Lake Indexing", desc: "Re-indexing the primary data lake f... optimized query performance across", type: "progress", value: 34 },
    { id: "#REQ-8287", status: "QUEUED", title: "Security Audit Scan", desc: "Automated security audit scan for a... external-facing API endpoints.", type: "wait", value: "~12m 10s", pct: 5 },
  ];
